...
$(document).ready(function () {
	...
	$("#downloadGrid").jqGrid({
		...
		colNames:['', '제목', '내용', '파일 ID', '파일명', '실제 저장파일명', '작성자', '첨부파일', '작성일', '게시글 번호', '작성자 사번'],
		colModel: [
			{ index : 'NUM', 				name: 'NUM', 				width : 5, 	align : 'center', hidden:true },
			{ index: 'DOWNLOAD_TITLE', 		name: 'DOWNLOAD_TITLE',		width: 50, 	align: 'left', formatter: htmlTag},
			{ index: 'DOWNLOAD_CON', 		name: 'DOWNLOAD_CON',		width: 100, align: 'left', formatter: htmlTag},
			{ index: 'DOWNLOAD_ID', 		name: 'DOWNLOAD_ID',		width: 100, align: 'left',  hidden:true},
